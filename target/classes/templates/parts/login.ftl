...
<form action="${path}" method="post">
    ...
    <div class="col-sm-6">
        <div class="g-recaptcha" data-sitekey="6LdmCcIUAAAAANqX_6kVeDqYHcWptjVjt1Ij_jeE"></div>
        <#if captchaError??>
    ...
    <button class="btn btn-primary mr-3" type="submit"><#if isRegisterForm>Create<#else>Sign In</#if></button>
